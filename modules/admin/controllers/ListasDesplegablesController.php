...
class ListasDesplegablesController extends \app\controllers\AppController
{
    ...
    public function actionCreateAjax()
    {
        ...
        try{
            ...
            if ($request->post('params_val1')   && $request->post('params_val2') ) {
                $model->is_tipo        = EsysListaDesplegable::TIPO_CONCEPTO;
                $model->param_val1     = $request->post('params_val1');
                $model->param_val2     = $request->post('params_val2');
            }
    ...
    public function actionUpdateAjax()
    {
        ...
        try{
            ...
            if ($request->post('params_val1')   && $request->post('params_val2') ) {
                ...
                $model->is_tipo         = null;
                $model->param_val1      = null;
                $model->param_val2      = null;
            }
