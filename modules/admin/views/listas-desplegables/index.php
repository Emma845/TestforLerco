	            ...
	            <div class="modal-content">
	                ...
	                <div class="modal-body">
	                    <div class="form-horizontal">
	                        ...
	                        <div class="div_form_reembolso" style="display: none">
	                        	<div class="form-group params_val1">
		                            <label class="col-sm-3 control-label" for="input">Cuenta : </label>
	                            	<div class="col-sm-8">
	                                	<?= Html::input('number', 'params_val1', null, ['class' => 'form-control', 'placeholder' => 'Cuenta :']) ?>
	                                </div>
		                        </div>
	                    		<div class="form-group params_val2">
		                            <label class="col-sm-3 control-label" for="input">Clave</label>
		                            <div class="col-sm-8">
		                            	<div class="input-group mar-btm text-center">
		                            		<?= Html::dropDownList('params_val2', null,[
		                            			"A" => "A => Abonos",
		                            			"C" => "C => Cargo",
		                            		], ['prompt' => 'Tipo: ', 'class' => 'form-control', 'id' => 'params_val2' ]) ?>
		                            	</div>
		                            </div>
		                        </div>
