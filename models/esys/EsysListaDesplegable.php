...
class EsysListaDesplegable extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['id_2', 'orden', 'created_at', 'created_by', 'updated_at', 'updated_by','is_tipo'], 'integer'],
            [['param1', 'param2', 'label'], 'string', 'max' => 32],
            [['param_val1', 'param_val2'], 'string', 'max' => 50],
    ...
    public function attributeLabels()
    {
       return [
            ...
            'param1' => 'Parametro 1',
            'param2' => 'Parametro 2',
            'param_val1' => 'Parametro val 1',
            'param_val2' => 'Parametro val 2',
...
//------------------------------------------------------------------------------------------------//
     ...
     * @return JSON string
     */
    public static function getItems($label, $for_json = false)
    {
        $query = self::find()
            ->select('id, singular, plural, is_tipo, param_val1, param_val2')
            ->andWhere([
                'label' => $label,
            ])
            ->orderBy('orden');
